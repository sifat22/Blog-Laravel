...
<div class="col-10">
    <div class="card">
        <div class="card-body">
            ...
            <form method="post" action="{{route('insert_blog.section')}}" enctype="multipart/form-data">
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="tags" class="form-control" type="text" id="example-text-input">
           ...
           <input name="blog_image" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
            <img id="showImage" class="rounded avatar-lg" src="{{ url('upload_image/admin_image/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
