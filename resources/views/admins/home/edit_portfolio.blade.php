    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{ $edit_data->name }}" id="example-text-input">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="title" class="form-control" type="text" value="{{ $edit_data->title }}" id="example-text-input">
           ...
           <input name="images" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
  <img id="showImage" class="rounded avatar-lg" src="{{ url($edit_data->images) }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
