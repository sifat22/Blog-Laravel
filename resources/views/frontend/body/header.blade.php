...
<li class="{{($route == 'home_portfolio.section')? 'active' : ''}}"><a href="{{route('home_portfolio.section')}}">Portfolio</a></li>
<li class="{{($route == 'home_blog')? 'active' : ''}}"><a href="{{route('home_blog')}}">Blog</a></li>

<li lass="{{($route == 'contact')? 'active' : ''}}"><a href="{{route('contact')}}">contact me</a></li>
</ul>
</div>
