                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8 col-md-10">
                            <div class="breadcrumb__wrap__content">
                                <h2 class="title">{{ $edit_blog->blog_title }}</h2>
...
<div class="col-lg-8">
    <div class="standard__blog__post">
        <div class="standard__blog__thumb">
            <img src="{{ asset($edit_blog->blog_image) }}" alt="">
        </div>
        <div class="blog__details__content services__details__content">
            <ul class="blog__post__meta">
                <li><i class="fal fa-calendar-alt"></i> {{ ($edit_blog->created_at)->diffForHumans() }}</li>


            </ul>
            <h2 class="title">{{ $edit_blog->blog_title }}</h2>
            <p> {!! $edit_blog->blog_desc !!} </p>
        </div>
        <div class="blog__details__bottom">
            <ul class="blog__details__tag">
                <li class="title">Tag:</li>
                <li class="tags-list">
                    <a href="#">{{ $edit_blog->tags }}</a>
    ...
    <aside class="blog__sidebar">
            ...
            <ul class="rc__post">
                ...
                <li class="rc__post__item">
                    <div class="rc__post__thumb">
                        <a href="{{route('blog_details',$all->id)}}"><img src="{{ asset($all->blog_image) }} " alt=""></a>
                    </div>
                    <div class="rc__post__content">
                        <h5 class="title"><a href="{{route('blog_details',$all->id)}}">{{ $all->blog_title }}
                         </a></h5>
        ...
        <div class="widget">
            ...
            <ul class="sidebar__cat">
                ...
                <li class="sidebar__cat__item"><a href="{{route('catby_blog',$cat->id)}}">{{ $cat->category_name  }}  </a></li>
                @endforeach
            </ul>
        </div>
        <div class="widget">
