...
@section('main')
 ...
 <main>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8 col-md-10">
                            <div class="breadcrumb__wrap__content">
                                <h2 class="title">{{ $get_details_data->name }}</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{url{'/'}}">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $get_details_data->name }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
  ...
  <img src=" {{ asset($get_details_data->images) }} " alt="">
                            </div>
                            <div class="services__details__content">
                                <h2 class="title">{{ $get_details_data->title }}</h2>
                                <p> {!! $get_details_data->desc !!} </p>
